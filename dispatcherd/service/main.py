...
class DispatcherMain(DispatcherMainProtocol):
    def __init__(self, producers: Iterable[Producer], pool: WorkerPool, shared: SharedAsyncObjectsProtocol, node_id: Optional[str] = None):
        ...
        self.delayed_runner = NextWakeupRunner(self.delayed_messages, self.process_delayed_task, shared=shared, name='delayed_task_runner')
    ...
    async def shutdown(self) -> None:
        ...
        await self.delayed_runner.kick()  # to process shutdown
